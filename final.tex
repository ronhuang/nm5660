...
transparency: \textit{The danger of transparency is that the interface will
mask the operation of the system exactly when the user needs to see
and understand what the system is doing} \cite{windows:bolter}. As
described by Norman, the designers and the users each have their own
