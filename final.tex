...
proposed experiments on gathering patterns of user experience for
bringing balance in transparency and reflection to the user interface.

For future works, we will build the application and conduct the
proposed experiments. Hopefully some patterns of user experience will
be abstractified from the results gathered. Then another experiments
will be conducted to evaluate the accuracy and effectiveness of these
patterns.
