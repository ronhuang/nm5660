...
product. Table~\ref{tab:shield} gives a simple example of patterns of
user experience for error prevention \citep{patterns:welie}. Many
patterns of user experience from various facets of human-computer
...
\citet{participatory:dearden} examined the patterns to enable users to
