...
product. A simplified example for patterns of user experience may say:
``You can change your mind immediately.'' The software engineers may
implement this pattern by adding the `undo' feature into the software.
